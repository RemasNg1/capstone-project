...
class UserTempModel {
 ...
 //   password varchar(255) [not null]
  ...
  UserTempModel({required this.id, required this.name, required this.email, required this.avatar, required this.status, required this.notificationId});
}
...
List<UserTempModel> users = [
  UserTempModel(
    ...
    name: "Omar Alsulami",
    email: "omar@omar.com",
    avatar: "https://images.unsplash.com/photo-1599566150163-29194dcaad36?crop=faces&fit=crop&w=200&h=200",
  ...
  UserTempModel(
    ...
    avatar: "https://images.unsplash.com/photo-1529626455594-4ff0802cfb7e?crop=faces&fit=crop&w=200&h=200",
    status: EnumUserStatus.online,
  ...
  UserTempModel(
    ...
    name: "Ali Zain",
    email: "ali@zain.com",
    avatar: "https://images.unsplash.com/photo-1524504388940-b1c1722653e1?crop=faces&fit=crop&w=200&h=200",
  ...
  UserTempModel(
    ...
    avatar: "https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?crop=faces&fit=crop&w=200&h=200",
    status: EnumUserStatus.online,
  ...
  UserTempModel(
    ...
    avatar: "https://images.unsplash.com/photo-1520813792240-56fc4a3765a7?crop=faces&fit=crop&w=200&h=200",
    status: EnumUserStatus.online,
