...
class ServiceModelMapper extends ClassMapperBase<ServiceModel> {
  ...
  static const Field<ServiceModel, String> _f$description = Field(
    'description',
    _$description,
  );
  ...
  static const Field<ServiceModel, List<DateTimeRangeModel>> _f$dates = Field(
    'dates',
    _$dates,
  );
  ...
  static const Field<ServiceModel, String> _f$category = Field(
    'category',
    _$category,
  );
  static String _$categoryAr(ServiceModel v) => v.categoryAr;
  static const Field<ServiceModel, String> _f$categoryAr = Field(
    'categoryAr',
    _$categoryAr,
  );
  static String _$categoryEn(ServiceModel v) => v.categoryEn;
  static const Field<ServiceModel, String> _f$categoryEn = Field(
    'categoryEn',
    _$categoryEn,
  );
  static int _$regionId(ServiceModel v) => v.regionId;
  static const Field<ServiceModel, int> _f$regionId = Field(
    'regionId',
    _$regionId,
  );
  ...
  static const Field<ServiceModel, double> _f$latitude = Field(
    'latitude',
    _$latitude,
  );
  static double _$longitude(ServiceModel v) => v.longitude;
  static const Field<ServiceModel, double> _f$longitude = Field(
    'longitude',
    _$longitude,
  );
  static List<String> _$imageUrls(ServiceModel v) => v.imageUrls;
  static const Field<ServiceModel, List<String>> _f$imageUrls = Field(
    'imageUrls',
    _$imageUrls,
  );
...
mixin ServiceModelMappable {
  String toJson() {
    return ServiceModelMapper.ensureInitialized().encodeJson<ServiceModel>(
      this as ServiceModel,
    );
  }

  Map<String, dynamic> toMap() {
    return ServiceModelMapper.ensureInitialized().encodeMap<ServiceModel>(
      this as ServiceModel,
    );
  }
  ...
  @override
  String toString() {
    return ServiceModelMapper.ensureInitialized().stringifyValue(
      this as ServiceModel,
    );
  }
  ...
  bool operator ==(Object other) {
    return ServiceModelMapper.ensureInitialized().equalsValue(
      this as ServiceModel,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return ServiceModelMapper.ensureInitialized().hashValue(
      this as ServiceModel,
    );
  }
}
