...
class ProviderModelMapper extends ClassMapperBase<ProviderModel> {
  ...
  static const Field<ProviderModel, String> _f$id = Field(
    'id',
    _$id,
    opt: true,
  );
  static String? _$nameAr(ProviderModel v) => v.nameAr;
  static const Field<ProviderModel, String> _f$nameAr = Field(
    'nameAr',
    _$nameAr,
    key: r'name_ar',
  );
  static String? _$nameEn(ProviderModel v) => v.nameEn;
  static const Field<ProviderModel, String> _f$nameEn = Field(
    'nameEn',
    _$nameEn,
    key: r'name_en',
  );
  static String? _$descriptionAr(ProviderModel v) => v.descriptionAr;
  static const Field<ProviderModel, String> _f$descriptionAr = Field(
    'descriptionAr',
    _$descriptionAr,
    key: r'description_ar',
  );
  static String? _$descriptionEn(ProviderModel v) => v.descriptionEn;
  static const Field<ProviderModel, String> _f$descriptionEn = Field(
    'descriptionEn',
    _$descriptionEn,
    key: r'description_en',
  );
  static String? _$avatar(ProviderModel v) => v.avatar;
  static const Field<ProviderModel, String> _f$avatar = Field(
    'avatar',
    _$avatar,
    opt: true,
  );
  ...
  static const Field<ProviderModel, String> _f$commercialRegistrationNumber =
      Field(
        ...
        _$commercialRegistrationNumber,
        key: r'commercial_registration_number',
        opt: true,
      );
  static String? _$phoneNumber(ProviderModel v) => v.phoneNumber;
  static const Field<ProviderModel, String> _f$phoneNumber = Field(
    'phoneNumber',
    _$phoneNumber,
    key: r'phone_number',
  );
  static String? _$authId(ProviderModel v) => v.authId;
  static const Field<ProviderModel, String> _f$authId = Field(
    'authId',
    _$authId,
    key: r'auth_id',
    opt: true,
  ...
  static const Field<ProviderModel, DateTime> _f$createdAt = Field(
    'createdAt',
    _$createdAt,
    key: r'created_at',
    opt: true,
  ...
  static const Field<ProviderModel, DateTime> _f$updatedAt = Field(
    'updatedAt',
    _$updatedAt,
    key: r'updated_at',
    opt: true,
...
class _ProviderModelCopyWithImpl<$R, $Out>
  ...
  ProviderModel $make(CopyWithData data) => ProviderModel(
    ...
    commercialRegistrationNumber: data.get(
      #commercialRegistrationNumber,
