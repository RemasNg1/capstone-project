...
class ServiceModelMapper extends ClassMapperBase<ServiceModel> {
  ...
  static List<String> _$dates(ServiceModel v) => v.dates;
  static const Field<ServiceModel, List<String>> _f$dates =
      Field('dates', _$dates);
...
abstract class ServiceModelCopyWith<$R, $In extends ServiceModel, $Out>
  ...
  ListCopyWith<$R, String, ObjectCopyWith<$R, String, String>> get dates;
...
class _ServiceModelCopyWithImpl<$R, $Out>
  ...
  @override
  ListCopyWith<$R, String, ObjectCopyWith<$R, String, String>> get dates =>
      ListCopyWith($value.dates, (v, t) => ObjectCopyWith(v, $identity, t),
          (v) => call(dates: v));
  @override
  ListCopyWith<$R, String, ObjectCopyWith<$R, String, String>> get imageUrls =>
